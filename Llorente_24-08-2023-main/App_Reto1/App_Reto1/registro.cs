...
namespace App_Reto1
{
    public class cls_registro
    {
        ...
        private string str_plazo;

        public void registro(string codigo, string nombre, string apellido, string contacto, string correo, string direccion, string estado, string salario, string plazo)
        {
            if ( codigo == "" || nombre== "" || apellido== "" || contacto== "" || correo== "" || direccion== "" || estado== "" || salario== "")
            {
                str_mensaje = "por favor llene los campos";
            }
            else
            {
                try
